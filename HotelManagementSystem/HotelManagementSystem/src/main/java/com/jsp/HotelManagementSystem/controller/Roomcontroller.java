...
public class Roomcontroller 
{
	...
	@ApiResponses(value = {@ApiResponse(code = 201, message = "room succesfully created"),@ApiResponse(code = 404, message = "room not saved give proper input")})
	@PostMapping
	...
	@ApiResponses(value = {@ApiResponse(code = 200, message = "room succesfully updated"),@ApiResponse(code = 404, message = "room not updated give proper input")})
	@PutMapping
	...
	@ApiResponses(value = {@ApiResponse(code = 200, message = "room succesfully delete"),@ApiResponse(code = 404, message = "room not deleted give proper input")})
	@DeleteMapping
	...
	@ApiOperation(value = "get room by id", notes = "api is used to get room details based on id")
	@ApiResponses(value = {@ApiResponse(code = 302, message = "succesfully found room"),@ApiResponse(code = 404, message = "room not found give proper input")})
	@GetMapping
	...
	@ApiOperation(value = "get room by no", notes = "api is used to get room details based on no")
	@ApiResponses(value = {@ApiResponse(code = 302, message = "succesfully found room"),@ApiResponse(code = 404, message = "room not found give proper input")})
	@GetMapping("/roombyno")
	...
	@ApiOperation(value = "get room by type", notes = "api is used to get room details based on type")
	@ApiResponses(value = {@ApiResponse(code = 302, message = "succesfully found room"),@ApiResponse(code = 404, message = "room not found give proper input")})
	...
	@ApiOperation(value = "get room by availability", notes = "api is used to get room details based on availability")
	@ApiResponses(value = {@ApiResponse(code = 302, message = "succesfully found room"),@ApiResponse(code = 404, message = "room not found give proper input")})
	...
	@ApiOperation(value = "get all rooms", notes = "api is used to get all rooms details")
	@ApiResponses(value = {@ApiResponse(code = 302, message = "succesfully found rooms"),@ApiResponse(code = 404, message = "room not found give proper input")})
