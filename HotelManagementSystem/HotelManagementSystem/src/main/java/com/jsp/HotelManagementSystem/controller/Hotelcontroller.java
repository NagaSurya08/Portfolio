...
public class Hotelcontroller 
{
	...
	@ApiResponses(value = {@ApiResponse(code = 201, message = "hotel succesfully created"),@ApiResponse(code = 404, message = "hotel not saved give proper input")})
	@PostMapping
	...
	@ApiResponses(value = {@ApiResponse(code = 200, message = "hotel succesfully updated"),@ApiResponse(code = 404, message = "hotel not updated give proper input")})
	@PutMapping
	...
	@ApiResponses(value = {@ApiResponse(code = 200, message = "hotel succesfully delete"),@ApiResponse(code = 404, message = "hotel not deleted give proper input")})
	@DeleteMapping
	...
	@ApiResponses(value = {@ApiResponse(code = 302, message = "succesfully found hotel"),@ApiResponse(code = 404, message = "hotel not found give proper input")})
	@GetMapping
