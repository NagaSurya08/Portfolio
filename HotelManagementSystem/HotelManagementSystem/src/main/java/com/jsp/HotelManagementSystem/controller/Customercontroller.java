...
public class Customercontroller
{
	...
	@ApiResponses(value = {@ApiResponse(code = 201, message = "customer succesfully created"),@ApiResponse(code = 404, message = "customer not saved give proper input")})
	@PostMapping
	...
	@ApiResponses(value = {@ApiResponse(code = 200, message = "customer succesfully updated"),@ApiResponse(code = 404, message = "customer not updated give proper input")})
	@PutMapping
	...
	@ApiResponses(value = {@ApiResponse(code = 200, message = "customer succesfully delete"),@ApiResponse(code = 404, message = "customer not deleted give proper input")})
	@DeleteMapping
	...
	@ApiResponses(value = {@ApiResponse(code = 302, message = "succesfully found customer"),@ApiResponse(code = 404, message = "customer not found give proper input")})
	@GetMapping
	...
	@ApiOperation(value = "get all customers", notes = "api is used to get all customers details")
	@ApiResponses(value = {@ApiResponse(code = 302, message = "succesfully found customers"),@ApiResponse(code = 404, message = "customers not found give proper input")})
	...
	@ApiResponses(value = {@ApiResponse(code = 302, message = "succesfully login customer"),@ApiResponse(code = 404, message = "customer not found give proper input")})
